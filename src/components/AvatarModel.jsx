...
function AvatarModel({ modelPath, height, weight, skinColor, hairType }) {
  ...
  useEffect(() => {
    ...
    // This ensures we get accurate bounding box without animation influence
    ...
    // This ensures the model fits regardless of original mesh size
    const fixedScale = 0.0005 // Very small fixed scale for large meshes
    clonedModel.scale.set(fixedScale, fixedScale, fixedScale)

    // Update matrix to ensure scale is applied
    ...
    // Don't move it up - keep feet at ground level
