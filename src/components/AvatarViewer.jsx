  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg border border-[#e5e7eb] p-8 animate-fade-in">
      ...
      <div className="relative mb-6">
        {loading && modelPath && (
          <div className="absolute inset-0 flex items-center justify-center bg-white/90 backdrop-blur-sm rounded-xl z-10">
            <div className="text-center">
              <div className="animate-spin rounded-full h-8 w-8 border-2 border-[#dc2626] border-t-transparent mx-auto mb-3"></div>
        ...
        <div className="w-full h-[600px] rounded-xl bg-[#f9fafb] overflow-hidden border border-[#e5e7eb]" style={{ minHeight: '600px' }}>
          <AvatarScene
            modelPath={modelPath}
            height={height}
            weight={weight}
